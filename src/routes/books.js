...
router.get("/search", (req, res) => {
    request
        .get(
            `https://www.goodreads.com/search/index.xml?key=kdU80WhJaG8n3rrFUXNJg&q=${req.query.q}`
...
router.get("/fetchPages", (req, res) => {
    ...
    request
        .get(
            `https://www.goodreads.com/book/show.xml?key=kdU80WhJaG8n3rrFUXNJg&id=${goodreadsId}`
